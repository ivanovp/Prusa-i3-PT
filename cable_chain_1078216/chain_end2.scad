                ...
                union()
                   {
                    ...
                    translate([0,15.1,0])
                        rotate(a=0, v=[0,0,1])
                            cube([(height/13)*(length-7.5),width * 0.8,2]);
                    translate([(height/13)*(length-7.5),0.1,(height/13)*6.5])
                        rotate(a=90, v=[-1,0,0])
                            cylinder(r=(height/13)*6.5, h=width);
                   }
                   
                translate([length / 8 * 1.8, 15 + width / 2, 0]) cylinder(d=4.2,h=height);
                translate([length / 8 * 3.7, 15 + width / 2, 0]) cylinder(d=4.2,h=height);
                translate([length / 8 * 1.8, width / 2, 0]) cylinder(d=4.2,h=height);
                translate([length / 8 * 3.7, width / 2, 0]) cylinder(d=4.2,h=height);
                /*
                hull()
                {
                    translate([length / 8, width / 2, 0]) cylinder(d=2.5,h=height);
                    translate([length / 8 * 3, width / 2, 0]) cylinder(d=2.5,h=height);
                }
                */
    ...
    union()
        {
            ...
            translate([(length / 10),3.4,(height/13)*3.5])
                rotate(a=0, v=[0,0,1])
                    cube([length / 2.2,width-6.6,(height/13)*10]);    
