        ...
        difference()
            {
                ...
                translate([0,0.1,0])
                    rotate(a=0, v=[0,0,1])
                        cube([length,width,(height/13)*13]);
                translate([length * 0.35,15.1,0])
                    rotate(a=0, v=[0,0,1])
                        cube([length * 0.65,width * 0.8,2]);
                }

                translate([length / 8 * 4, 15 + width / 2, 0]) cylinder(d=4.2,h=height);
                translate([length / 8 * 6, 15 + width / 2, 0]) cylinder(d=4.2,h=height);
                translate([length / 8 * 4, width / 2, 0]) cylinder(d=4.2,h=height);
                translate([length / 8 * 6, width / 2, 0]) cylinder(d=4.2,h=height);
    ...
    union()
        {
            ...
            translate([(length / 2) - 4,3.4,(height/13)*3.5])
                rotate(a=0, v=[0,0,1])
                    cube([length / 2,width-6.6,(height/13)*10]);    
